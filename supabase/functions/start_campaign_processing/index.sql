-- Função para iniciar o processamento da campanha, validando scheduled_for
...
-- Para aplicar essa função, você deve substituir a função RPC atual start_campaign_processing pelo conteúdo acima.